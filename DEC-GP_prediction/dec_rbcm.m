...
for j=1:nt
    ...
    if   nearest_neighbors(j)  > 1
        ...
        for i=1:n
            beta_dist_comp(i,1) = .5*( log(kss_e(j))   - log(s2_all_real(i)) );
        ...
        if iter_dac_convrg_max_min(1,j) > n_all && n_all <= 5 % flooding
            ...
            s2_inv_dist_comp(j) = sum(l_dist_comp(:,1)) + (1-sum(beta_dist_comp(:,1)))/kss_e(j);
            ...
            s2_inv_dist_comp(j) = n*l_dist_comp(1,iter_dac_convrg_max_min(1,j)) + (1-n*beta_dist_comp(1,iter_dac_convrg_max_min(1,j)))/kss_e(j);
            s2_dist_comp(j) = (1/s2_inv_dist_comp(j));
        ...
        if iter_dac_convrg_max_min_1(1,j) > n_all && n_all <= 5 % flooding
            ...
            s2_inv_dist_1_hop(j) = sum(l_dist_1(:,1)) + (1-sum(beta_dist_1(:,1)))/kss_e(j);
            ...
            s2_inv_dist_1_hop(j) = n*l_dist_1(1,iter_dac_convrg_max_min_1(1,j)) + (1-n*beta_dist_1(1,iter_dac_convrg_max_min(1,j)))/kss_e(j);
            s2_dist_1_hop(j) = (1/s2_inv_dist_1_hop(j));
        ...
        if iter_dac_convrg_max_min_2(1,j) > n_all && n_all <= 5 % flooding
            ...
            s2_inv_dist_2_hop(j) = sum(l_dist_2(:,1)) + (1-sum(beta_dist_2(:,1)))/kss_e(j);
            ...
            s2_inv_dist_2_hop(j) = n*l_dist_2(1,iter_dac_convrg_max_min_2(1,j)) + (1-n*beta_dist_2(1,iter_dac_convrg_max_min(1,j)))/kss_e(j);
            s2_dist_2_hop(j) = (1/s2_inv_dist_2_hop(j));
