...
for j=1:nt
    ...
    if   nearest_neighbors(j)  > 1
        ...
        if iter_dac_convrg_max_min(1,j) > n_all && n_all <= 5 % flooding
            ...
            s2_inv_dist_comp(j) = sum(l_dist_comp(:,1)) + (1-models{1}.Ms)/kss_e(j);
            ...
            s2_inv_dist_comp(j) = n*l_dist_comp(1,iter_dac_convrg_max_min(1,j)) + (1-models{1}.Ms)/kss_e(j);
            s2_dist_comp(j) = (1/s2_inv_dist_comp(j));
        ...
        if iter_dac_convrg_max_min_1(1,j) > n_all && n_all <= 5 % flooding
            ...
            s2_inv_dist_1_hop(j) = sum(l_dist_1(:,1)) + (1-models{1}.Ms)/kss_e(j);
            ...
            s2_inv_dist_1_hop(j) = n*l_dist_1(1,iter_dac_convrg_max_min_1(1,j)) + (1-models{1}.Ms)/kss_e(j);
            s2_dist_1_hop(j) = (1/s2_inv_dist_1_hop(j));
        ...
        if iter_dac_convrg_max_min_2(1,j) > n_all && n_all <= 5 % flooding
            ...
            s2_inv_dist_2_hop(j) = sum(l_dist_2(:,1)) + (1-models{1}.Ms)/kss_e(j);
            ...
            s2_inv_dist_2_hop(j) = n*l_dist_2(1,iter_dac_convrg_max_min_2(1,j)) + (1-models{1}.Ms)/kss_e(j);
            s2_dist_2_hop(j) = (1/s2_inv_dist_2_hop(j));
